...
public static class ClaudeSystemPrompt
{
    ...
    public static string Embedded(ClaudeLaunchOptions o)
    {
        ...
        sb.AppendLine("- Keep working until the task is done. Verify at milestones, not after every edit: one capture_viewport (640 px is enough) once a group of edits is done, read_console with sinceSequence for anything new. End each turn with a short summary of what changed and what you would do next.");
