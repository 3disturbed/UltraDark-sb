...
The catalogue is loaded once per session by every agent: 88 tools, 47,400 characters, about 11,800 tokens
...
- After a change: `dotnet SexyBiscuit.Editor/bin/Debug/net8.0/SexyBiscuit.Editor.dll --dump-mcp-tools --all --markdown --budget 48000`
