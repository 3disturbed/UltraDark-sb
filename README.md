...
- **Current limitation:** box selection, selection pivots/shared multi-transform modes, world/local mode in native, plane handles and surface/vertex snapping are not implemented yet.
